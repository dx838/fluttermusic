...
final List<AutoCloseItem> AutoCloseList = [
  ...
  AutoCloseItem(label: "90 分钟", value: const Duration(minutes: 90)),
  AutoCloseItem(label: "120 分钟", value: const Duration(minutes: 120)),
  AutoCloseItem(label: "150 分钟", value: const Duration(minutes: 150)),
];
